			...
			<div className="flexbox">
				...
				<div className="info-box">
					<div className="weather-box" id="weatherBox">
						<p className="city-name" id="cityName"></p>
						<p className="day1" id="day1"></p>
						...
						<p className="day2" id="day2">
							<span className="days" id="day2Name">
								<br />
							</span>
						</p>
						<p className="day3" id="day3">
							<span className="days" id="day3Name">
								<br />
							</span>
						</p>
						<p className="day4" id="day4">
							<span className="days" id="day4Name">
								<br />
							</span>
						</p>
						<p className="day5" id="day5">
							<span className="days" id="day5Name">
								<br />
							</span>
						</p>
					...
					<div className="currency-box">
						<form className="form-box" id="currencyForm">
							...
							<label className="cost-tab" id="costTab">
								Cost in
							</label>
							<div className="hotel">
								<label for="hotel" className="hotel-name">
									Hotel
								</label>
							</div>
							<div className="food">
								<label for="food" className="food-name">
									Food
								</label>
							</div>
							...
							<div className="transportation">
								<label
									for="transportation"
									className="transportation-name"
								>
									Transportation
								</label>
							</div>
							<label
								className="hotel-us-cost"
								id="hotelBrazilCost"
							>
								R$340
							</label>
							<label className="food-us-cost" id="foodBrazilCost">
								R$56
							</label>
							<label
								className="entertainment-us-cost"
								id="entertainmentBrazilCost"
							>
								R$50
							</label>
							<label
								className="transportation-us-cost"
								id="transportationBrazilCost"
							>
								R$4200
							</label>
							<label
								className="hotel-user-cost"
								id="hotelUserCost"
							></label>
							<label
								className="food-user-cost"
								id="foodUserCost"
							></label>
							<label
								className="entertainment-user-cost"
								id="entertainmentUserCost"
							></label>
							<label
								className="transportation-user-cost"
